...
longitude = data[0].lon;
    ...
    const url = `http://api.open-meteo.com/v1/forecast?latitude=${latitude}&longitude=${longitude}&timezone=IST&daily=temperature_2m_max,temperature_2m_min,sunrise,sunset,uv_index_max&hourly=visibility,relative_humidity_2m&current=temperature_2m,relative_humidity_2m,wind_speed_10m`
  ...
  sunset.innerText=`${data1.daily.sunset[0]}\n\n\n ${data1.daily.sunset[1]}\n\n\n${data1.daily.sunset[2]}\n\n\n${data1.daily.sunset[3]}\n\n\n${data1.daily.sunset[4]}\n\n\n ${data1.daily.sunset[5]}\n\n\n ${data1.daily.sunset[6]}\n\n\n `
    ...
    const newurl = `http://air-quality-api.open-meteo.com/v1/air-quality?latitude=${latitude}&longitude=${longitude}&current=pm10,pm2_5,uv_index`
